...
const TestConfigScreen = () => {
  ...
  const [numQuestions, setNumQuestions] = useState(cards?.length.toString());
  ...
  return (
    <SafeAreaView className={Platform.OS === "android" ? "pt-6" : ""}>
      ...
      <View className="p-5 space-y-4">
        ...
        <TouchableOpacity disabled={numQuestions === ""} onPress={onSubmit} className={`${ numQuestions === "" ? "bg-gray-400" : "bg-blue-600"} py-3 rounded-md`}>
